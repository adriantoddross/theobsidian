...
$(function(){
  ...
  */
  ...
  $('.Topbar__topbarMenuSpacer__3hqBi, .Topbar__topbarListingButton__2SNl8, .branding-content').remove();
  ...
  $('#topbar-container input:first-of-type').attr("placeholder", "I'm looking for...");

  $('.MenuMobile').after( $('<div/>',{ "class": "login-container"})
    .append( $('<button>LOG IN</button>',{ "class": "login-button"}) )
  );
  ...
  if (browserWidth > 768 && url1.includes('category=') ) {
    ...
    $(".Logo img").attr("src", "https://res.cloudinary.com/adriantoddross/image/upload/v1550194310/TheObsidian.png");
  } else {
    // if class is somehow still there... remove it!
    $("#topbar-container").removeClass("category-page");
  }
